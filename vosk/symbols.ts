export const vosk_SYMBOLS = {
  ...
  _recognizer_partial_result: {
    name: "vosk_recognizer_partial_result",
    parameters: ["pointer"],
    result: "pointer"
  },
  _recognizer_final_result: {
